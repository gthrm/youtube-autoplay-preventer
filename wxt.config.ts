...
export default defineConfig({
  manifest: {
    ...
    version: "1.0.0",
    description:
      "Block YouTube video autoplay on hover. Prevent unwanted video previews, save bandwidth, and stop annoying sounds. Essential YouTube browsing enhancement for better user experience.",
